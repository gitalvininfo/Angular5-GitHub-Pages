								...
								<div class="panel-body">
									<form>
										...
										<div class="form-group">
											...
											<select class="form-control select" name="method" data-live-search="true">
										...
										<div class="form-group">
											<button type="submit" class="btn btn-warning btn-md">Purchase</button>
										</div>  
									</form>
								</div>
							</div>
		...
		<div class="modal fade" id="new_purchase" tabindex="-1" role="dialog" aria-labelledby="smallModalHead" aria-hidden="true">
			<div class="modal-dialog modal-sm">
				<div class="modal-content">
					...
					<form role="form" class="form-horizontal" action="actions/purchase.php" method="post" onsubmit="return confirm('Add to Quotation?');">
