				...
				<div class="col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<h3 class="panel-title"><strong>Product Purchase</strong><span style="font-size:12px;"> </span></h3>
						...
						<div class="panel-body">
							<div class="row">
								<?php
								$query1 = $conn->query("SELECT * FROM `purchase` where `user_id` = '$_GET[id]' ORDER BY `purchase_id` DESC") or die(mysqli_error());
								...
								<p><span style="font-size:12px;">Quotation Number: 000<?php echo $fetch1['purchase_id']?></span></p><br>
								...
								<table class="table table-bordered">
									...
									<?php
	$conn = new mysqli ("localhost", "root", "", "sales") or die(mysqli_error());
									$query = $conn->query("SELECT * FROM `purchase` where `user_id` = '$_GET[id]' && `status` = 'Pending' ORDER BY `purchase_id` DESC") or die(mysqli_error());
									$grand = 0;
